...
-- 메인쿼리 : InvoiceId, CustomerId, 청구 금액
...
-- SELECT 'Employee' AS Type : Type이라는 컬럼을 만들고 'Employee'라는 값을 집어넣음
...
-- HINT : WHERE절 CustomerId 활용해서 서브쿼리
SELECT
    CustomerId,
...
-- 고객 이름 구하기(고객ID, FirstName, LastName)
