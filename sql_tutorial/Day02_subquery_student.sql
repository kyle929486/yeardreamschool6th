...
-- 서브쿼리 : invoice_items의 TrackId 조회
...
-- 서브쿼리 : 'Rock' 장르의 트랙이 담긴 앨범의 ID
---- 서브쿼리 메인 : 앨범 ID 조회
SELECT AlbumID FROM tracks;
---- 서브쿼리 서브 : Rock 장르 ID 조회
